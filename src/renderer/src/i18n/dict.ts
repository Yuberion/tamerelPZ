...
export const EN = {
  ...
  'led.diagExpand': 'Expand diagnostics panel',
  'led.diagCollapse': 'Collapse diagnostics panel',
  'led.diagTitle': 'Smart Diagnostics & Crash Analysis',
  'led.diagIssues': 'issues found',
  'led.diagShowAll': 'Show all',
  'led.diagResetFilter': 'Reset issue filter',
  'led.diagFilteredTo': 'Filtered to: {title}',
  'led.diag.compatTitle': 'Java API Incompatibility (B41 / B42 mismatch)',
  'led.diag.compatHint': 'Calls missing or removed engine methods. Check if an updated B42 port exists.',
  'led.diag.luaNilTitle': 'Lua Nil Value Dereference',
  'led.diag.luaNilHint': 'Script tried to index or call a nil variable or function in Lua.',
  'led.diag.scriptTitle': 'Item / Recipe Script Syntax Error',
  'led.diag.scriptHint': 'Check media/scripts: B42 requires base: prefixes and valid property names.',
  'led.diag.assetTitle': 'Missing Texture or 3D Model Asset',
  'led.diag.assetHint': 'Engine failed to locate the specified texture or 3D model asset in media folder.',
  'led.diag.oomTitle': 'JVM Out of Memory (Heap / Direct)',
  'led.diag.oomHint': 'Increase JVM memory allocation (-Xmx) in ProjectZomboid64.json or reduce heavy mods.',
  'led.diag.worldTitle': 'Map Cell or World Loading Conflict',
  'led.diag.worldHint': 'Check map mod load order so custom maps load before vanilla.',

  'led.live': 'Live Tail',
  'led.liveTitle': 'Auto-stream new lines from the game in real time',
  'led.liveActive': 'Live Stream',
  'led.liveActiveTitle': 'Live streaming of console.txt is active',
  'led.follow': 'Follow',
  'led.followTitle': 'Auto-scroll to the bottom when new lines arrive',
  'led.loadFull': 'Full log',
  'led.loadFullTitle': 'Load the entire log file (up to 50 MB) instead of 1 MB tail',
  'led.fullLoaded': 'Full log',
  'led.tailOnlyTitle': 'Switch back to the 1 MB tail of the file',
  'led.dedupe': 'Repeats',
  'led.dedupeTitle': 'Fold consecutive identical log entries',
  'led.allMods': 'All sources',
  'led.coreEngine': 'Vanilla / Engine Core',
  'led.filterModTitle': 'Filter entries by specific mod',
  'led.filterByThisMod': 'Filter by mod',
  'led.filterByThisModTitle': 'Show only incidents attributed to this mod',
  'led.filterVanilla': 'Filter vanilla',
  'led.filterVanillaTitle': 'Show only vanilla / engine core errors',
  'led.revealGame': 'Game folder',
  'led.revealGameTitle': 'Open game installation folder in Explorer',
  'led.revealGameLua': 'Game Lua',
  'led.revealGameLuaTitle': 'Open vanilla media/lua folder in Explorer',
  'led.exportBtn': 'Export',
  'led.exportBtnTitle': 'Generate a sanitized crash report for Discord or GitHub',
  'led.exportTitle': 'Crash & Error Report',
  'led.exportMaskPaths': 'Mask user paths (C:\\Users\\<user>)',
  'led.exportErrorsOnly': 'Errors and fatal crashes only',
  'led.exportIncludeTraces': 'Include Lua / Java stack traces',
  'led.copyReport': 'Copy for Discord',
  'led.reportCopied': 'Report copied to clipboard',
  'led.cleanArchive': 'Clean archive',
  'led.cleanArchiveTitle': 'Delete old log files in Zomboid/Logs (keep 10 newest)',
  'led.cleanConfirm': 'Delete older log files in Zomboid/Logs (keep 10 newest)?',
  'led.cleanedResult': 'Deleted {count} old logs, freed {bytes}',
  'led.newErrorsToast': '+{n} new error(s) logged by game',
  'led.sbFolded': 'folded {n} repeats',
  'led.openInNpp': 'Notepad++',
  'led.openInNppTitle': 'Open this file in Notepad++ at the call-site line',
  'led.openedInNpp': 'Opened in Notepad++',
  'led.openedInEditor': 'Opened in editor',
  'led.fileNotFound': 'File not found on disk',
  'led.noScriptInLog': 'No specific script file referenced in this log entry',
  'led.openEditor': 'Open',
  'led.openEditorTitle': 'Open in system default editor',
  'led.revealFile': 'Reveal file',
  'led.revealFileTitle': 'Show file in File Explorer',
  'led.openSourceTitle': 'Open source file in editor (double-click row)',
  'led.close': 'Close',
  'led.cancel': 'Cancel',

  // ---- ledger: stage timeline & options 1,2,4,5,6 -------------------------
  'led.stage.engine': 'Engine & JVM Init',
  'led.stage.scripts': 'Scripts & Items',
  'led.stage.mods': 'Mods & Lua Init',
  'led.stage.world': 'Map & World Gen',
  'led.stage.game': 'In-Game Active',
  'led.launchPhases': 'Launch Phases',
  'led.clearPhaseFilter': 'All phases (click active phase to reset)',
  'led.timelineHint': 'Click a launch stage to filter errors occurring in that boot phase',

  'led.compareSessions': 'Diff',
  'led.compareSessionsTitle': 'Compare errors between current log and previous session',
  'led.baseSession': 'Previous Session (Baseline)',
  'led.currentSession': 'Current Session (Target)',
  'led.newErrors': 'New Errors',
  'led.resolvedErrors': 'Resolved',
  'led.recurringErrors': 'Recurring',
  'led.filterOnlyNewErrors': 'Filter only new errors ({count})',
  'led.clearDiffFilterTitle': 'Reset diff filter',
  'led.onlyNewErrors': 'Only new errors',
  'led.analyzingDiff': 'Analyzing session logs…',
  'led.noDiffEntries': 'No entries in this category',

  'led.decompileJava': 'Java Decompile',
  'led.decompileJavaTitle': 'Inspect method bytecode or signatures directly from projectzomboid.jar',
  'led.methods': 'methods',
  'led.filterMethods': 'Filter methods…',
  'led.decompilingFromJar': 'Decompiling {className} from projectzomboid.jar…',
  'led.javapNotice': 'Decompiled using javap engine disassembly from projectzomboid.jar',
  'led.copyDecompiled': 'Copy Java',
  'led.decompiledCopied': 'Decompiled Java code copied',

  'led.shareDiscord': 'Discord',
  'led.shareDiscordTitle': 'Copy formatted markdown incident report for Discord or forums',
  'led.discordCopied': 'Discord markdown card copied to clipboard',

  'led.linesRange': 'lines {from}–{to}',
  'led.expandSnippet': 'Expand',
  'led.collapseSnippet': 'Reset',
  'led.expandRadiusTitle': 'Show 10 more lines before and after',
  'led.resetRadius': 'Reset context radius to 5 lines',
  'led.copySnippet': 'Copy code snippet',
  'led.loadingCode': 'Loading source code…',
  'led.codeCopied': 'Code snippet copied',
  'led.targetLine': 'Target line {line}'
} as const
...
export const RU: Record<TKey, string> = {
  ...
  // ---- ledger: расширенные возможности -------------------------------------
  'led.diagExpand': 'Развернуть блок диагностики',
  'led.diagCollapse': 'Свернуть блок диагностики',
  'led.diagTitle': 'Умная диагностика крашей',
  'led.diagIssues': 'проблем найдено',
  'led.diagShowAll': 'Показать все',
  'led.diagResetFilter': 'Сбросить фильтр проблемы',
  'led.diagFilteredTo': 'Отфильтровано по: {title}',
  'led.diag.compatTitle': 'Несовместимость Java API (B41 / B42)',
  'led.diag.compatHint': 'Вызов отсутствующих методов движка. Проверьте версию мода или обновите под B42.',
  'led.diag.luaNilTitle': 'Обращение к nil в Lua',
  'led.diag.luaNilHint': 'Попытка вызова функции или чтения поля nil-переменной в Lua-скрипте.',
  'led.diag.scriptTitle': 'Ошибка скрипта предметов или рецептов',
  'led.diag.scriptHint': 'Проверьте media/scripts: в B42 обязательны префиксы base: и валидные свойства.',
  'led.diag.assetTitle': 'Отсутствует ресурс (текстура / модель)',
  'led.diag.assetHint': 'Движок не смог найти файл текстуры или модели по указанному пути.',
  'led.diag.oomTitle': 'Нехватка памяти Java (Out of Memory)',
  'led.diag.oomHint': 'Увеличьте параметр -Xmx в ProjectZomboid64.json или отключите тяжелые моды.',
  'led.diag.worldTitle': 'Конфликт файлов карты или ячеек мира',
  'led.diag.worldHint': 'Проверьте порядок загрузки карт и отсутствие конфликтующих ячеек.',

  'led.live': 'Живой поток',
  'led.liveTitle': 'Автоматически отслеживать и подгружать новые строки из игры в реальном времени',
  'led.liveActive': 'Живой поток',
  'led.liveActiveTitle': 'Включен режим живого отслеживания console.txt',
  'led.follow': 'Следить',
  'led.followTitle': 'Автоматически прокручивать список вниз к новым записям',
  'led.loadFull': 'Полный лог',
  'led.loadFullTitle': 'Загрузить весь файл целиком (до 50 МБ) вместо 1 МБ хвоста',
  'led.fullLoaded': 'Весь лог',
  'led.tailOnlyTitle': 'Переключиться обратно на 1 МБ хвост файла',
  'led.dedupe': 'Повторы',
  'led.dedupeTitle': 'Группировать подряд идущие одинаковые ошибки',
  'led.allMods': 'Все источники',
  'led.coreEngine': 'Ванильный движок',
  'led.filterModTitle': 'Фильтровать ошибки по конкретному моду',
  'led.filterByThisMod': 'Только этот мод',
  'led.filterByThisModTitle': 'Показать в логе только ошибки и сообщения этого мода',
  'led.filterVanilla': 'Только ванилла',
  'led.filterVanillaTitle': 'Показать только ошибки ванильной игры и ядра',
  'led.revealGame': 'Папка игры',
  'led.revealGameTitle': 'Открыть папку установки игры в проводнике',
  'led.revealGameLua': 'Скрипты игры',
  'led.revealGameLuaTitle': 'Открыть папку media/lua игры в проводнике',
  'led.exportBtn': 'Экспорт',
  'led.exportBtnTitle': 'Создать очищенный отчет о краше для Discord или GitHub',
  'led.exportTitle': 'Отчет о краше и ошибках',
  'led.exportMaskPaths': 'Маскировать пути пользователя (C:\\Users\\<user>)',
  'led.exportErrorsOnly': 'Только ошибки и фатальные сбои',
  'led.exportIncludeTraces': 'Включать стектрейсы Lua / Java',
  'led.copyReport': 'Скопировать для Discord',
  'led.reportCopied': 'Отчет скопирован в буфер обмена',
  'led.cleanArchive': 'Очистить архив',
  'led.cleanArchiveTitle': 'Удалить старые файлы логов, оставив последние 10 сессий',
  'led.cleanConfirm': 'Удалить устаревшие файлы логов в папке Zomboid/Logs (оставить 10 самых свежих)?',
  'led.cleanedResult': 'Удалено {count} старых логов (освобождено {bytes})',
  'led.newErrorsToast': 'В логе появилось новых ошибок: {n}',
  'led.sbFolded': 'свернуто повторов: {n}',
  'led.openInNpp': 'Notepad++',
  'led.openInNppTitle': 'Открыть проблемный файл в Notepad++ на указанной строке',
  'led.openedInNpp': 'Файл открыт в Notepad++',
  'led.openedInEditor': 'Файл открыт в редакторе',
  'led.fileNotFound': 'Файл не найден на диске',
  'led.noScriptInLog': 'В этой записи лога нет ссылки на конкретный файл скрипта',
  'led.openEditor': 'Открыть',
  'led.openEditorTitle': 'Открыть в системном редакторе по умолчанию',
  'led.revealFile': 'В проводнике',
  'led.revealFileTitle': 'Показать файл в проводнике Windows',
  'led.openSourceTitle': 'Открыть исходный файл в редакторе (двойной клик по строке)',
  'led.close': 'Закрыть',
  'led.cancel': 'Отмена',

  // ---- ledger: stage timeline & options 1,2,4,5,6 -------------------------
  'led.stage.engine': 'Инициализация движка и JVM',
  'led.stage.scripts': 'Скрипты и предметы',
  'led.stage.mods': 'Моды и инициализация Lua',
  'led.stage.world': 'Карта и генерация мира',
  'led.stage.game': 'Активная игра',
  'led.launchPhases': 'Фазы запуска',
  'led.clearPhaseFilter': 'Все фазы (кликните по активной для сброса)',
  'led.timelineHint': 'Нажмите на фазу загрузки, чтобы отфильтровать ошибки этого этапа',

  'led.compareSessions': 'Сравнение',
  'led.compareSessionsTitle': 'Сравнить ошибки между текущим логом и предыдущей сессией',
  'led.baseSession': 'Предыдущая сессия (база)',
  'led.currentSession': 'Текущая сессия (цель)',
  'led.newErrors': 'Новые ошибки',
  'led.resolvedErrors': 'Устранены',
  'led.recurringErrors': 'Повторяющиеся',
  'led.filterOnlyNewErrors': 'Показать только новые ошибки ({count})',
  'led.clearDiffFilterTitle': 'Сбросить фильтр сравнения сессий',
  'led.onlyNewErrors': 'Только новые ошибки',
  'led.analyzingDiff': 'Сравнение сессий логов…',
  'led.noDiffEntries': 'В этой категории записей нет',

  'led.decompileJava': 'Декомпиляция Java',
  'led.decompileJavaTitle': 'Изучить байткод и сигнатуры методов прямо из projectzomboid.jar',
  'led.methods': 'методов',
  'led.filterMethods': 'Поиск методов…',
  'led.decompilingFromJar': 'Декомпиляция {className} из projectzomboid.jar…',
  'led.javapNotice': 'Декомпилировано с помощью встроенного javap из projectzomboid.jar',
  'led.copyDecompiled': 'Копировать Java',
  'led.decompiledCopied': 'Декомпилированный код скопирован',

  'led.shareDiscord': 'Discord',
  'led.shareDiscordTitle': 'Скопировать форматированную карточку инцидента для Discord или форумов',
  'led.discordCopied': 'Карточка инцидента для Discord скопирована в буфер',

  'led.linesRange': 'строки {from}–{to}',
  'led.expandSnippet': 'Расширить',
  'led.collapseSnippet': 'Сброс',
  'led.expandRadiusTitle': 'Показать на 10 строк больше до и после',
  'led.resetRadius': 'Сбросить радиус контекста до 5 строк',
  'led.copySnippet': 'Скопировать фрагмент кода',
  'led.loadingCode': 'Загрузка исходного кода…',
  'led.codeCopied': 'Фрагмент кода скопирован',
  'led.targetLine': 'Целевая строка {line}'
}
